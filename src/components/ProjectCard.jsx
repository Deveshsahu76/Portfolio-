...
export default function ProjectCard({ project, compact = false }) {
  return (
    ...
    >
      <div className="relative min-h-[225px] overflow-hidden bg-gradient-to-br from-violet-600 via-blue-600 to-cyan-500 p-4">
        ...
        {project.image ? (
          <img
            ...
            className="relative h-full min-h-[195px] w-full rounded-[1.4rem] object-cover shadow-2xl ring-1 ring-white/25 transition duration-500 group-hover:scale-[1.04]"
            onError={(e) => {
        ...
        <div className={`${project.image ? 'hidden' : ''} relative min-h-[195px] rounded-[1.4rem] bg-white/90 p-4 shadow-2xl ring-1 ring-white/30 dark:bg-slate-950/82`}>
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <h3 className="text-2xl font-black tracking-tight text-slate-950 dark:text-white">{project.title}</h3>

        <p className="mt-3 leading-7 text-slate-600 dark:text-slate-400">{project.description}</p>

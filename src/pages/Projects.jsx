  ...
  return (
    <>
      <SEO
        ...
        description="Explore full-stack MERN projects by Devesh Sahu including Queens Arena, E-Commerce Store, Zerodha Clone and Version Control System."
        path="/projects"
      ...
      <main className="section-container">
        <section className="mb-10">
          ...
          <p className="page-subtitle mt-6 max-w-3xl">
            These projects cover frontend UI, backend APIs, database models,
            authentication, deployment and real product flows.
          </p>
        </section>
